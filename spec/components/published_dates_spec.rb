RSpec.describe("PublishedDates", type: :view) do
  ...
  it "renders full page history" do
    render_component(published: "1st November 2000", last_updated: "15th July 2015", history: [{ display_time: "23 August 2013", note: "Updated with new data" }])
  ...
  it "accordion has GA4 tracking" do
    render_component(published: "1st November 2000", last_updated: "15th July 2015", history: [{ display_time: "23 August 2013", note: "Updated with new data" }])
    expected_ga4_json = { event_name: "select_content", type: "content history", section: "Footer" }.to_json
