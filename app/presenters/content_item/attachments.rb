module ContentItem
  ...
  private
    ...
    def preview_url(doc)
      ...
      in { preview_url: String, asset_manager_id:, filename: }
        # We have asset_manager_id and filename, so we can redirect to a new style CSV preview
        ...
        "/csv-preview/#{asset_manager_id}/#{filename}"
