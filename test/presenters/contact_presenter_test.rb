...
class ContactPresenterTest
  class PresentedContact < PresenterTestCase
    ...
    test "presents webchat" do
      ...
      assert_equal presented.webchat_config["availability-url"], "https://www.tax.service.gov.uk/csp-partials/availability/1030"
      assert_equal presented.webchat_config["open-url"], "https://www.tax.service.gov.uk/csp-partials/open/1030"
    end
  end
end
